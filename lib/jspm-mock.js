...
exports.default = jspmMockFactory;
...
Private.prototype = {
    ...
    get: async function get(module) {
        ...
        return _System.import(module).catch(this.handleError).then(this.getModuleContent);
    },
...
var Extra = {
    ...
    unmockModules: function unmockModules(mocked_modules) {
        var jspmMock = this;
        var unmock = jspmMock.unmock.bind(jspmMock);
...
function jspmMockFactory(system) {
    var api = Public;
