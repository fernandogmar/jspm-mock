...
Private.prototype = {
    ...
    mockFromObject: function mockFromObject(module, fakeModule) {
        this.mockFromString(module, 'module.exports = ' + (0, _tosource2.default)(fakeModule));
    },
    mockFromString: function mockFromString(module, fakeSource) {
        this.reset(module);
...
var Public = {
    ...
    mock: function mock(module, fake) {
        ...
        } else if (_lodash2.default.isString(fake)) {
